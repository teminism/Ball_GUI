...
public class BBallGame extends JFrame {
    ...
    public static final int[] BOX_X = { BOX_MARGIN, BOX_MARGIN, BOX_MARGIN + Ball.BOX_WIDTH, BOX_MARGIN + Ball.BOX_WIDTH };
    public static final int[] BOX_Y = { BOX_MARGIN + Ball.BOX_HEIGHT, BOX_MARGIN, BOX_MARGIN, BOX_MARGIN + Ball.BOX_HEIGHT };
    public final Ball[] ballArray = new Ball[10];

    public BallPanel panel;
    public int paddleX = BOX_MARGIN + Ball.BOX_WIDTH / 2;
    public int paddleY = BOX_MARGIN + Ball.BOX_HEIGHT;
    ...
    public BBallGame() {
        ...
        setSize(Ball.BOX_WIDTH + 2 * BOX_MARGIN, Ball.BOX_HEIGHT + 2 * BOX_MARGIN);
        setResizable(false);
        initBallArray();
        panel = new BallPanel();
        add(panel);
